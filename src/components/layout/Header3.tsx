    ...
    return (
        <>
            <header
                className={
                    scroll
                        ? `${headerStyle} header header3 pt-0 sticky-bar stick header-type-2`
                        : `${headerStyle} header header3 pt-0 sticky-bar header-type-2`
                }>
                <div className="w-full bg-red">
                    <div className="container">
                        <div className="header-contact-info">
                            ...
                            <div className="color-green-100 color-white pl-10">
                    ...
                    <div className="main-header">
                        ...
                        <div className="header-right">
                            <div className="block-signin">
                                <Link
                                    to="/page-signup"
                                    className="btn btn-black hover-up icon-arrow-right-white icon-arrow-right">
                                    Get Started{" "}
                                </Link>
                            </div>
                        </div>
