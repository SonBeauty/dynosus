...
const Header5: React.FC<HeaderProps> = ({ handleOpen, headerStyle }) => {
                    ...
                    <div className="main-header">
                        ...
                        <div className="header-right">
                            <div className="block-signin">
                                < Link to="/page-signup" className="btn btn-green-900 hover-up icon-arrow-right-white icon-arrow-right">Get Started</Link>
                            </div>
                        </div>
                    </div>
                </div>
