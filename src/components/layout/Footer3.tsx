                    ...
                    <div className="footer-top">
                        <div className="row">
                            ...
                            <div className="col-md-8 col-sm-6 text-center text-md-end">
                                ...
                                <Link to="/page-signup" className="btn btn-square">Create an Account</Link>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 text-center text-lg-end text-md-end">
                                <div className="footer-social">
                                    <Link to="https://facebook.com" className="icon-socials icon-facebook-red">
                                    </Link>
                                    <Link to="https://twitter.com" className="icon-socials icon-twitter-red">
                                    </Link>
                                    <Link to="https://www.instagram.com" className="icon-socials icon-instagram-red">
                                    </Link>
                                    <Link to="https://www.linkedin.com" className="icon-socials icon-linkedin-red">
                                    </Link>
                                </div>
                            </div>
                        </div>
