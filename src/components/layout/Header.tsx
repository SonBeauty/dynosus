                                ...
                                <nav className="nav-main-menu d-none d-xl-block">
                                    <ul className="main-menu">
                                        ...
                                        <li className="has-children">
                                            ...
                                            <ul className="sub-menu">
                                                <li>
                                                    <Link to="#"><i className="fi fi-rr-edit" />Contact</Link>
                                                </li>
                                                <li>
                                                    <Link to="/page-signup"><i className="fi fi-rr-edit" />Sign Up</Link>
                                                </li>
                                                <li>
                                                    <Link to="/page-login"><i className="fi fi-rr-edit" />Log In</Link>
                                                </li>
                                                <li>
                                                    <Link to="/page-reset"><i className="fi fi-rr-edit" />Reset Password</Link>
                                                </li>
                                                <li>
                                                    <Link to="/404"><i className="fi fi-rr-edit" />Error 404</Link>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
