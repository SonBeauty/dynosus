...
const Header7: React.FC<HeaderProps> = ({ handleOpen, headerStyle }) => {
    ...
    return (
        <>
            <header className={scroll ? `${headerStyle} header header7 sticky-bar stick ` : `${headerStyle} header header7 sticky-bar`}>
                                    ...
                                    <ul className="main-menu">
                                        ...
                                        <li className="has-children">
                                            ...
                                            <ul className="sub-menu">
                                                <li>
                                                    <Link to="/page-about-1 "><i className="fi fi-rr-star" />About Us - 1</Link>
                                                </li>
                                                <li>
                                                    <Link to="/page-about-2 "><i className="fi fi-rr-star" />About Us - 2</Link>
                                                </li>
                                                <li>
                                                    <Link to="/page-about-3 "><i className="fi fi-rr-star" />About Us - 3</Link>
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="has-children">
