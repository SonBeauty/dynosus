...
const WeDoSlider: React.FC = () => {
    const data = [
        ...
        },
        {
            ...
            text: "Our experienced tailors meticulously adjust the garments, including hemming, seam adjustments, and more."
        },
        {
            img: "check-all.svg",
            title: "Quality Assurance",
            text: "After alterations, our quality assurance team rigorously inspects each garment, checking fit, stitching, and craftsmanship to ensure."
        },
        {
            img: "iron.svg",
            title: "Final Touches and Pressing",
            text: "Before delivery, we add final touches, such as pressing or steaming, to ensure impeccable appearance, eliminating wrinkles and presenting."
        },
        {
            img: "delivery.svg",
            title: "Packaging and Delivery",
            text: "After completing alterations and final touches, we securely package the garments for transit. Prompt delivery to the customer's."
        }
    ];
    return (
        <>
