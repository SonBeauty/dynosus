        ...
        <>
            <div className="container mt-20">
                <div className="text-center block-bill-2 mt-10">
                    ...
                    <label className="switch ml-20 mr-20 price-table-3">
                ...
                <div className="block-pricing block-pricing-2 price-table-3 mt-70">
                    <div className="row">
                            ...
                            <div className="row">
                                <div className="col-xl-3 col-lg-6 col-md-6 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    <div className="box-pricing-item hover-up">
                                        ...
                                        <div>
                                            <Link to="/#" className="btn btn-black text-body-lead icon-arrow-right-white text-start">Get Started
                                            </Link>
                                        </div>
                                    </div>
                                </div>
