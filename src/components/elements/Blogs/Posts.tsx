...
const PostsComponent: React.FC<PostsProps> = ({ bigTitle, description, postsData }) => {
  ...
  return (
    <div className="section-box mt-80">
      ...
      <div className="container mt-60 posts">
        <div className="row">
          {mainPosts && mainPosts.map((post, i) =>
            <div className="col-lg-4 col-sm-6 pr-30 mb-30" key={i}>
              <div className="card-grid-style-4">
                ...
                <Link to={post.link} className="text-heading-5 posts-title color-gray-900">{post.title}</Link>
                <p className="text-body-text posts-description color-gray-500 mt-10">{post.decription}</p>
          ...
          <div className="col-lg-4 col-sm-12 pr-30 mb-30">
            {subPosts && subPosts.map((post, i) =>
              <div className="card-list-style-1" key={i + 2}>
                <Link to={post.link} className="text-heading-6 sub-posts-title">{post.title}</Link>
                <div className="blog-img-user">
