...
export const PricingData2: PricingData[] = [
  {
    ...
    decription: 'Make your perfect trousers the ideal length with our hemming service.',
    features: [
      'Precise Hemming',
      'Customizable Fit',
      'Length Adjustment',
  ...
  },
  {
    ...
    decription: 'Refresh and rejuvenate your clothing with our button replacement service.',
    features: [
...
export const PricingData3: PricingData[] = [
  {
    title: 'Standard',
    decription: 'All the basics for businesses that are just getting started.',
    features: [
